          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {quizzes.map((quiz) => {
              ...
              return (
                <div
                  key={quiz.id}
                  className="bg-white border border-stone-200 hover:border-red-400 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between space-y-4"
                >
                  <div className="space-y-3">
                    ...
                    <div className="p-3 bg-stone-50 rounded-xl border border-stone-200/80 text-xs flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold text-xs transition-colors flex items-center justify-center space-x-2 shadow-sm"
                  >
