      ...
      <section className="pt-14 pb-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8">
          <button
            ...
            className="w-full sm:w-auto px-7 py-4 bg-red-600 hover:bg-red-700 text-white rounded-2xl text-sm sm:text-base font-bold shadow-lg shadow-red-600/25 hover:shadow-xl transition-all flex items-center justify-center space-x-3 cursor-pointer active:scale-95 group"
          >
            {/* Google Icon */}
            ...
            <span>গুগল দিয়ে ১ ক্লিকে শুরু করুন (ফ্রি ৫০ কয়েন সহ)</span>
